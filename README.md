...
- Integrations: Google Calendar OAuth + Resend API email delivery
...
- Resend and Google OAuth credentials should be set in a production-safe secret manager or environment store.
