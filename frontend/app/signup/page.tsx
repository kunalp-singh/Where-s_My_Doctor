...
export default function SignUpPage() {
  ...
  const roleColors: Record<string, string> = {
    patient: "bg-[#3e6b63] shadow-[0_4px_12px_rgba(62,107,99,0.3)]",
    doctor: "bg-[#0f766e] shadow-[0_4px_12px_rgba(15,118,110,0.3)]",
    admin: "bg-[#b45309] shadow-[0_4px_12px_rgba(180,83,9,0.3)]",
  };
  ...
  return (
    <main className="relative flex min-h-[calc(100vh-73px)] items-center justify-center overflow-hidden bg-gradient-to-b from-[#edf4ef] via-[#f8f6f0] to-[#f1f6f2] p-6 text-[#21322a]">
      ...
      <div className="pointer-events-none absolute -left-12 -top-12 h-80 w-80 opacity-[0.05] select-none">
      ...
      <Card className="relative z-10 w-full max-w-md rounded-3xl border border-[#d7e2db] bg-[#f9f7f1]/90 backdrop-blur-md shadow-[0_16px_50px_rgba(44,66,58,0.1)]">
        <CardHeader className="border-b border-[#d7e2db]/70 px-6 py-5 text-center">
          ...
          <CardTitle className="text-2xl font-black text-[#21322a]">Create Account</CardTitle>
          <p className="mt-1 text-xs font-medium text-[#587066]">
            Join Appointment Care for personalised healthcare
          </p>
        </CardHeader>
        ...
        <CardBody className="px-6 py-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1.5 grid grid-cols-3 gap-1.5 rounded-full border border-[#d7e2db] bg-white p-1">
            ...
            <div>
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[#42564f]">
                Password <span className="font-normal text-[#587066]">(min. 8 characters)</span>
              </label>
              <input
                type="password"
                required
            ...
            {role === "doctor" && (
              <p className="mt-1 text-center text-[11px] text-[#587066]">
                Doctor accounts require admin approval before accessing the doctor console.
              </p>
            )}
          </form>
          ...
          <p className="mt-6 text-center text-xs text-[#587066]">
            ...
            <Link href="/login" className="font-bold text-[#3e6b63] underline hover:text-[#21322a]">
              Log In
            </Link>
          </p>
        </CardBody>
